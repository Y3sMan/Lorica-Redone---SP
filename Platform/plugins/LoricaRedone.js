    ...
    skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.hooks.sendPapyrusEvent.add({
        enter: function (ctx) {
            ...
            (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('menuClose', function () {
                ...
                SetPapyrusUtilOptions();
                (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.UnsetStringValue)(null, "YM.Lorica.Menu.Upkeep.Input");
                (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.UnsetStringValue)(null, "YM.Lorica.Menu.Utility.Input");
                if ((0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, _YM_Lorica_Shared__WEBPACK_IMPORTED_MODULE_3__.suKeys.bChargingEnable, 1) == 0) {
                    // printConsole('Destroying widgets')
                    (0,_LoricaRedone__WEBPACK_IMPORTED_MODULE_5__.DestroyLoricaTexts)();
                }
                if ((0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, _YM_Lorica_Shared__WEBPACK_IMPORTED_MODULE_3__.suKeys.bChargingEnable, 1) == 1) {
                    // printConsole('Creating widgets')
                    (0,_LoricaRedone__WEBPACK_IMPORTED_MODULE_5__.DestroyLoricaTexts)();
                    (0,_LoricaRedone__WEBPACK_IMPORTED_MODULE_5__.CreateWidgets)();
                }
                if ((0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, "YM.LORICA.MCM.UPDATE", 0) == 1) {
                    (0,_YM_Lorica_Compat__WEBPACK_IMPORTED_MODULE_4__.UpdateAllSpells)();
                }
                (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, "YM.LORICA.MCM.UPDATE", 0);
            });
        },
        ...
        enter: function (ctx) {
            ...
            (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('update', function () {
                ...
                if (setting.toLowerCase().includes('list')) {
                    ...
                    var blacklist_whitelist = function (list) {
                        var key = '';
...
(function (Setting_to_List) {
    ...
    Setting_to_List["iSelectedUtilityBlacklist:Lists"] = "Upkeep";
