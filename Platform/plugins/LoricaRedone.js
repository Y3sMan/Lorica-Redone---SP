...
var ChargeTime_V_Cost_Equation = function (spell) {
    ...
    // 				 {	10/90^2	* (cost - solution)^2	0 <= x <= iChargeCostAsymptote
    // charge_time = |	
    ...
    var slope = User_Pref_Upper_Bound / Math.pow((User_Pref_Cost_Asymptote - solution), 2);
    if (fCost >= 0 && fCost < User_Pref_Cost_Asymptote && fCost > solution) {
        charge_time = slope * Math.pow((fCost - solution), 2);
    }
