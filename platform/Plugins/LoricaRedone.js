...
skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.hooks.sendAnimationEvent.add({
    enter: function (ctx) {
        ...
        if (animEvent.includes("spellready")) {
            var SpellDurationBlock_1 = function (spellHand, timer, flag, duration) {
                var equipped;
                var eventName = '';
                if (spellHand.toLowerCase() == 'left') {
                    equipped = skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.Form.from(skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.Game.getPlayer().getEquippedSpell(0));
                    eventName = 'mlh';
                }
                if (spellHand.toLowerCase() == 'right') {
                    equipped = skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.Form.from(skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.Game.getPlayer().getEquippedSpell(1));
                    eventName = 'mrh';
                }
                if (isInWrongLists(equipped)) {
                    timer = 0;
                    flag = false;
                    return;
                }
            ...
            (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('update', function () {
                bUpkeepCast = true;
                (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)(fChargeTimerL);
                SpellDurationBlock_1('left', fChargeTimerL, bUpkeepCast, Spellduration);
                SpellDurationBlock_1('right', fChargeTimerR, bUpkeepCast, Spellduration);
            });
        }
        ...
        if (animEvent.includes("spellrelease")) {
            (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('update', function () {
                ...
                if (!isInWrongLists(left) || !isInWrongLists(right)) {
