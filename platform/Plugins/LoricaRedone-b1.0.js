...
var mainMCM = function () {
    ...
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('menuOpen', function () {
        if ((0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.GetIntValue)(null, "YM.Lorica.MCM.MenuOpenFlag", 0) == 1) {
            (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.once)('update', function () {
                (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)('whoahhaoa');
                (0,_skyrim_platform_papyrus_util_StorageUtil__WEBPACK_IMPORTED_MODULE_1__.SetIntValue)(null, "YM.Lorica.MCM.MenuOpenFlag", 0);
            });
        }
        ;
    });
    ...
    //   event for when player inputs in the Upkeep search option; filters the enum upkeep accordingly
    skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.hooks.sendPapyrusEvent.add({
        enter: function (ctx) {
            (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)("".concat(ctx.papyrusEventName, " has been caught"));
    ...
    (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.on)('browserMessage', function (event) {
        var msg = JSON.stringify(event.arguments);
        (0,skyrimPlatform__WEBPACK_IMPORTED_MODULE_0__.printConsole)("the last chosen is ".concat(msg));
    });
};
